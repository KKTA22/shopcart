...
useEffect(()=>{
    if (ship){
        ...
        if (instal==="0-3"){
            prop.setfiltprd(prd.filter((item)=>item.installments>=0 && item.installments<4 && item.freeship===true))
        }
        else if (instal==="4-6"){
            prop.setfiltprd(prd.filter((item)=>item.installments>=4 && item.installments<7 && item.freeship===true))
        }
        else if (instal==="More than 6"){
            prop.setfiltprd(prd.filter((item)=>item.installments>=6 && item.freeship===true))
        }
        else{
        ...
        if (instal==="0-3"){
            prop.setfiltprd(prd.filter((item)=>item.installments>=0 && item.installments<4))
        }
        else if (instal==="4-6"){
            prop.setfiltprd(prd.filter((item)=>item.installments>=4 && item.installments<7))
        }
        else if (instal==="More than 6"){
